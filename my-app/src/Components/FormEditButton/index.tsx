...
import {
  ActionButtonType,
  ButtonStateHoverType,
  ButtonType,
} from '../../Ducks/Types/buttonTypes';
...
export const FormEditButton = () => {
  ...
  const [stateHover, setStateHover] = useState<ButtonStateHoverType>({});
  ...
  const handleOkClick = () => {
    ...
    return dispatch(editButtons(urlBtn, dataPostButtons));
  };
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="form_with_styles">
        <p className="header_create_new">edit button</p>
