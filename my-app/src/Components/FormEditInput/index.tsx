...
export const FormEditInput = () => {
  ...
  const [stateHover, setStateHover] = useState<InputStateHoverType>({});
  ...
  const handleOkClick = () => {
    ...
    return dispatch(editInputs(urlInput, dataPostInputs));
  };
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="form_with_styles">
        <p className="header_create_new">edit input</p>
